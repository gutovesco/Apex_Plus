...
class VideoaulaTwo extends StatefulWidget {
  @override
  _VideoaulaTwoState createState() => _VideoaulaTwoState();
}

class _VideoaulaTwoState extends State<VideoaulaTwo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:
            Text("Aula 2", style: GoogleFonts.robotoSlab(color: Colors.white)),
        centerTitle: true,
      ),
      body: LayoutBuilder(
